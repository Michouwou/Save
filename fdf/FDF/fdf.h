...
/*   Updated: 2016/05/23 16:30:40 by mlevieux         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_rotate_x(t_line *lines, int nb_lines, int n_per_line, int code);
void	ft_rotate_y(t_line *lines, int nb_lines, int n_per_line, int code);
void	ft_rotate_z(t_line *lines, int nb_lines, int n_per_line, int code);
