...
/*   Updated: 2016/03/14 13:39:14 by mlevieux         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
wchar_t			*ft_conv_wchar(char *string);
...
char			ft_what_type(char format_in_knot);
...
void			utf8(void);
char			*ft_base(intmax_t nb, int base);
void			ft_check_format(char *format);
char			*ft_repstr(char *print, int start, int end, char *to_insert);
