...
int				jlst_instances(j_list *first_node, void *data); /*returns the number of instances of 'data' in LIST*/
void			jlst_sort(j_list **first_node, int (*compare_func)(void*, void*)); /*sorts the list according to 'compare_func'*/
